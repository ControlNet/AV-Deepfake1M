...
The baseline Xception code is under MIT Licence. The BA-TFD/BA-TFD+ code is from [ControlNet/LAV-DF](https://github.com/ControlNet/LAV-DF) under CC BY-NC 4.0 Licence.
